...
#define leftMotorPWMPin 6      // orange
#define leftMotorDirPin 7      // brown
// Motor Rechts (vooraanzicht)
#define rightMotorPWMPin 5     // yellow
#define rightMotorDirPin 4     // green
...
void loop() {
  ...
  // PID NODIG OM
  if((count%20) == 0){
    distanceCm = sonar.ping_cm(); // Graden bereken, afstand motor om te compenseren
  }
